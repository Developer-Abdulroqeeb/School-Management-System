                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="item-content">
                                                ...
                                                <div class="item-number"><span class="counter" data-num="{{$notice_number}}">{{$notice_number}}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="notice-box-wrap">
                                    <div class="notice-list">
                                        ...
                                        <div class="post-date bg-skyblue">
                                            {{\Carbon\Carbon::createFromFormat('d/m/Y',$notices->date)->format('d-F-Y')}} 
                                        </div>
                                        <div class="entry-meta"><b> {{$notices->title}}</b></div>
                                        <h6 class="notice-title">{{$notices->details}}</h6>
                                        @endforeach
                                    </div>
                                    {{-- {{\Carbon\Carbon::createFromFormat('d/m/Y',$notice->date)->format('d-F-Y')}} --}}
                                </div>
                            </div>
                        </div>
                    </div>
