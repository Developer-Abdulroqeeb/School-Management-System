...
<head>
    ...
    <title>AKKHOR | Check for Session</title>
                                        ...
                                        <tbody>
                                         @foreach ($student as $allstudent )
                                            <tr>
                                                ...
                                                <td>
                            <a href="{{route("schoolproject.addresult",$allstudent->id )}}" class="dropdown-item" >Continue <i class="fas fa-eye text-yellow-red"></i>
                                                </td>
                                            </tr>
                                            @endforeach
                                       </tbody>
