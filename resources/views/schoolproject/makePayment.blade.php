    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <form class="new-added-form" method="POST" action="{{route("schoolproject.payexpenses")}}">
                @csrf
                    ...
                    <select name="expense_id" required class="select2" id="">
                        @foreach ( $query as $expense)
                        <option value="{{$expense->id}}">{{$expense->package_type}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-xl-3 col-lg-6 col-12 form-group">
