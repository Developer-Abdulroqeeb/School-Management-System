            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{route("schoolproject.addclass")}}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Date*</label>
                                    <input type="text" placeholder="dd/mm/yyyy" name="date" class="form-control air-datepicker" data-position="bottom right">
