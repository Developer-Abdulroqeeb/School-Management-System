            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{route("schoolproject.teacherform")}}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" name="dateofbirth" placeholder="dd/mm/yyyy" class="form-control air-datepicker">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="classteacher">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Role</label>
                                    <input type="text" placeholder="" name="role" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Address</label>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Salary</label>
                                    <input type="text" placeholder="" name="salary" class="form-control">
                               
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Starting date</label>
                                    <input type="text" name="starting_date" placeholder="dd/mm/yyyy" class="form-control air-datepicker">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Account Number</label>
                                    <input type="text" name="account_number" placeholder="" class="form-control">
                                    {{-- <i class="far fa-calendar-alt"></i> --}}
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Account Name</label>
                                    <input type="text" name="account_name" placeholder="" class="form-control ">
                                    {{-- <i class="far fa-calendar-alt"></i> --}}
                                </div>
