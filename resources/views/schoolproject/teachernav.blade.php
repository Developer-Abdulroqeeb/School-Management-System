                        ...
                        <li class="navbar-item dropdown header-admin">
                            <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="admin-title">
                                    <h5 class="item-title">{{$query->firstname}} {{$query->lastname}}</h5>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="item-content">
                                    <ul class="settings-list">
                                        <li><a href="{{route("schoolproject.teacherprofile",$query->id )}}"><i class="flaticon-user"></i>My Profile</a></li>

                                        <li><a href="{{route("schoolproject.teacher_accountsettings", $query->id)}}"><i class="flaticon-gear-loading"></i>Account Settings</a></li>
