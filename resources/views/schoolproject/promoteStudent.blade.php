...
<head>
    ...
    <title>AKKHOR | Promote Student</title>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                  <a  href="{{route("schoolproject.makePromotion",$classes->class)}}">Continue <i class="fas fa-chevron-right-alt text-orange-peel"></i> </a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
