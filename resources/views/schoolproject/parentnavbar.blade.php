@php
    ...
    $query = DB::table("studentparents")->where("id", $parentId)->first();
    $notices = notice::where("notice_for", "parent")->get();
                        ...
                        <li class="navbar-item dropdown header-admin">
                            <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="admin-title">
                                    <h5 class="item-title">{{$query->Surname}} {{$query->OtherName}}</h5>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="item-header">
                                    <h6 class="item-title">{{ $query->Surname}} {{$query->OtherName}}</h6>
                                </div>
                                <div class="item-content">
                                    <ul class="settings-list">
                                        <li><a href="{{route("schoolproject.parentprofile",$query->id)}}"><i class="flaticon-user"></i>My Profile</a></li>

                                        <li><a href="{{route("schoolproject.parent_accountsettings",$query->id)}}"><i class="flaticon-gear-loading"></i>Account Settings</a></li>
