...
<body>
   ...
   @foreach($students as $student)
                                            ...
                                            <tr>
                                                <td>Date Of Birth:</td>
                                                <td class="font-medium text-dark-medium">{{$student->DateOfBirth}}</td>
                                            </tr>
                                            <tr>
                                                <td>Religion:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium">{{$student->Phone}}</td>
                                                 ...
                                                 <tr>
                                                <td>password:</td>
                                                <td class="font-medium text-dark-medium">{{$student->password}}</td>
                                            </tr>
                                                <tr>
                                                <td>username:</td>
                                                <td class="font-medium text-dark-medium">{{$student->username}}</td>
                                            </tr>
                                             <tr>
                                                <td>Housing Mode</td>
                                                <td class="font-medium text-dark-medium">{{$student->housing_mode}}</td>
                                            </tr>
                                              <tr>
                                                <td>Hostel (if hostel):</td>
                                                <td class="font-medium text-dark-medium">{{$student->hostel}}</td>
                                            </tr>
                                               <tr>
                                                <td>Room number (if hostel):</td>
                                                <td class="font-medium text-dark-medium">{{$student->room_number}}</td>
                                            </tr>
                                            <tr>
                                                <td>Transport (if day):</td>
                                                <td class="font-medium text-dark-medium">{{$student->transport}}</td>
                                            </tr>
                                             <tr>
                                                <td>Parent Name</td>
                                                <td class="font-medium text-dark-medium">{{$student->parentname}}</td>
                                            </tr>
                                              <tr>
                                                <td>Parent Number</td>
