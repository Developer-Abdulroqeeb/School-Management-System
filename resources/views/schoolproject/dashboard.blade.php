...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 May 2025 02:33:24 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="{{ $student}}">{{ $student}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="{{ $teacher}}">{{ $teacher}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="{{ $parent}}">{{ $parent}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 May 2025 02:34:11 GMT -->
</html>