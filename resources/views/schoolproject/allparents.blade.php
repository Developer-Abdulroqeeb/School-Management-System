                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <form method="POST" action="{{route("schoolproject.deleteparent", $parent->id)}}">
                                                @method("DELETE")
                                                @csrf
                                                    ...
                                                    <a class="dropdown-item" href="{{route("schoolproject.parentsdetails",$parent->id)}}"><i
                                                            class="fas fa-eye-alt text-orange-peel"></i>view</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
