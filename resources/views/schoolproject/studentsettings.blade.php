                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" id="form" method="POST" enctype="multipart/form-data" action="{{route("schoolproject.studensettingsform", $student->id)}}">
                                    @method("PUT")
                                    @csrf
                                    @if (empty($student->profileImage))
                                    <img src="{{asset("img/figure/admin.jpg")}}" class="image_pick" alt="a">
                                    @else
                                    <img src="{{ asset('storage/' . $student->profileImage) }}" class="image_pick" alt="">
                                    @endif
