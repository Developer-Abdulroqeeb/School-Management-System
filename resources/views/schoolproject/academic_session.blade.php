            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Add New Academic Session</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Add New Acedemic Session</h3>
                            </div>
                           <div class="dropdown">
                        ...
                        <form class="new-added-form" method="POST" action="{{route("schoolproject.academic")}}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group" id="hostel">
                                   ...
                                   <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Enter Academic Session *</label>
                                    <input  required type="text" name="academic_session" placeholder="" class="form-control">
                                </div>
                                      <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Starting Date*</label>
                                    <input  required type="date" name="starting_date" placeholder="" class="form-control">
                                </div>
                                   <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Ending Date*</label>
                                    <input  required type="date" name="ending_date" placeholder="" class="form-control">
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <form  method="POST" action="{{route("schoolproject.delete_session", $session->id)}}">
                                                                @method("DELETE")
                                                                @csrf
